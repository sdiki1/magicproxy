...
from .database import DEFAULT_PLANS, Plan, ProxyPoolEntry, generate_proxy_credentials, now_ts
...
class PostgresDatabase:
    def __init__(self, dsn: str, proxy_pool_file: str | None = None):
        self.dsn = dsn
            ...
            async with self.conn.cursor() as cur:
                ...
                if pool_row is not None:
                    ...
                    await cur.execute(
                        """
                        UPDATE proxy_pool
                        SET status = 'free', assigned_link_id = NULL, username = %s, password = %s, updated_at = %s
                        WHERE assigned_link_id = %s
                        """,
